...
public class OptionParserTest extends TestCase {
	...
	public void testToggleOption() {
		...
		// test multiple short options
		{
			CommandLine op = new CommandLine("usage ...");
			ToggleOption verbose = op.addToggleOption("v", "verbose", "set the output to verbose");
			ToggleOption bandw = op.addToggleOption("b", "bandw", "set the display to black and white");
	 ...
	 * test the toggle option
	 */
	public void testToggleOptionNotSet() {
	 ...
	 * test the value option
	 */
	public void testValueOptionNotSet() {
	...
	public void testValuesOption() {
		...
		{
			CommandLine op = new CommandLine("usage ...");
			ValuesOption color = op.addValuesOption("c", "color", "color", "set the colors", new String[] { "purple" });
		...
		{
			CommandLine op = new CommandLine("usage ...");
			ValuesOption color = op.addValuesOption("c", "color", "color", "set the color",
					new String[] { "purple", "pink" });
		...
		{
			CommandLine op = new CommandLine("usage ...");
			ValuesOption color = op.addValuesOption("c", "color", "color", "set the color", new String[] { "purple" });
	 ...
	 * test the values option
	 */
	public void testValuesOptionNotSet() {
	...
	public void testHelp() {
		...
		// test toggle option
		{
			...
			String exp = "usage..." + NL + "    -v --verbose : set verbose output" + NL
					+ "    -w : set verbose output (short only)" + NL + "    --werbose : set verbose output (long only)"
					+ NL;
		...
		// test String option
		{
			...
			String exp = "usage..." + NL + "    -c <COLOR>, --color=<COLOR> : set color output (default to yellow)" + NL
		...
		// test Array option
		{
			...
			op.addValuesOption("d", null, "COLOR", "set color output (short only)", new String[] { "yellow" });
